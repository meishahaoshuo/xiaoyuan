...
class Report(db.Model):
    ...
    reporter_id = db.Column(db.Integer, db.ForeignKey('user.user_id'), nullable=False, comment='举报人编号')
    ...
    description = db.Column(db.String(1000), nullable=True, comment='举报说明')
    ...
    handler_id = db.Column(db.Integer, db.ForeignKey('user.user_id'), nullable=True, comment='管理员编号')
